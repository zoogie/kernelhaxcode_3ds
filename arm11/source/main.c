...
#define DS_INTERNET_CONTENT_ID_PROD 2
#define DS_INTERNET_CONTENT_ID_DEV  0x40a74d7e
#define DS_INTERNET_CONTENT_ID  (*(u8*)0x1FF80015 < 1 ? DS_INTERNET_CONTENT_ID_PROD : DS_INTERNET_CONTENT_ID_DEV)
